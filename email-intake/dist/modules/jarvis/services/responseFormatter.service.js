...
exports.formatJarvisResponse = formatJarvisResponse;
function countFromResult(result, key) {
    if (!result || typeof result !== "object")
        return 0;
    const v = result[key];
    return Array.isArray(v) ? v.length : 0;
}
function summaryForIntent(intent, result) {
...
function formatJarvisResponse(intent, result) {
    return {
        success: true,
        intent,
