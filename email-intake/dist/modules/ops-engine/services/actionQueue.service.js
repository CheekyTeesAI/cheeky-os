...
exports.buildActionQueue = buildActionQueue;
const prioritization_service_1 = require("./prioritization.service");
function buildActionQueue({ salesState, productionState }) {
    const salesTop = (0, prioritization_service_1.getTopSalesPriorities)(salesState);
    const prodTop = (0, prioritization_service_1.getTopProductionPriorities)(productionState);
    const ownerActions = [];
