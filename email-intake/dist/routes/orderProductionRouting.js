...
router.post("/api/orders/:id/route-production", async (req, res) => {
    try {
        ...
        const result = await (0, productionRoutingService_1.routeProductionForOrder)(orderId);
        ...
        const message = err instanceof Error ? err.message : "Failed to route production";
